...
```bash
npm run workflow:prompts:extract -- resources/default-content/default_normal_v35.json /tmp/rpgraph-prompts.json
npm run workflow:prompts:merge -- /tmp/rpgraph-prompts.json resources/default-content/default_normal_v35.json resources/default-content/default_normal_v35.json
```
