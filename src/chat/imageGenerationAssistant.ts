...
export const imageGenerationAssistantInstructions = [
  ...
  'Derive the camera angle and framing from who or what is actually capturing the image in the story context: the character photographing themselves, the character photographing someone else, another character taking the picture, a device left recording on its own, or any other setup the story establishes. Do not default to a habitual framing when the context implies a different one.',
